            ...
            */
	        ...
	        function (oSettings, aData, iDataIndex) {
	            ...
	            var iMax = document.getElementById(sToId).value * 1;
                    ...
                    //handle empty strings correctly (empty string multiplied by 1 equals 0)
                    if(document.getElementById(sFromId).value.match(/^\s*$/))
			{ iMin = NaN }

                    if(document.getElementById(sToId).value.match(/^\s*$/))
                       { iMax = NaN }
	            ...
	            else if (isNaN(iMin) && iValue <= iMax) {
	                return true;
	            }
	            else if (iMin <= iValue && isNaN(iMax)) {
	                return true;
	            }
